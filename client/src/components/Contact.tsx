...
${formData.message}`;
  ...
  return (
    <section id="contact" className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 font-heading">Phone</h4>
                  <p className="text-gray-200">+44 7366 187685</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 font-heading">Email</h4>
                  <p className="text-gray-200">moataz.yones244@gmail.com</p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1 font-heading">Location</h4>
                  <p className="text-gray-200">Available Worldwide</p>
                  <p className="text-sm text-gray-300">Arabic & English proficiency</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h4 className="text-lg font-semibold text-white font-heading">Quick Actions</h4>
              <div className="space-y-4">
                <a
                  href="https://docs.google.com/forms/d/e/1FAIpQLSePjBveQYC8IcYr0uCCuuo_Ue3kI4tVdUienhljFJHEBskU0Q/viewform"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full flex items-center justify-center space-x-3 bg-red-600/20 border border-red-500/30 text-red-400 py-4 rounded-lg hover:bg-red-500/30 transition-all duration-300 group relative overflow-hidden cyber-cursor glow-red"
                >
                ...
                <button className="w-full flex items-center justify-center space-x-3 bg-gray-600/20 border border-gray-500/30 text-gray-300 py-4 rounded-lg hover:bg-gray-500/30 transition-colors">
                  <MessageCircle className="w-5 h-5 text-white" />
                  <span className="text-white">Emergency Investigation Support</span>
                </button>
              </div>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <div className="bg-black/50 p-10 rounded-xl border border-red-500/30">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-200 mb-2 font-heading">
                    Name *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:border-red-500 focus:outline-none transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:border-red-500 focus:outline-none transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-red-600 to-red-500 text-white py-4 rounded-lg font-semibold hover:from-red-700 hover:to-red-600 transition-all duration-300 flex items-center justify-center space-x-2 group border border-red-400/30"
              >
